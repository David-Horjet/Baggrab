  ...
  if (loading && entries.length === 0) {
    return (
      <div className="max-w-6xl mx-auto">
        <h2 className="text-xl sm:text-2xl font-bold text-center mb-4 sm:mb-6 text-gray-300">{getFilterTitle()}</h2>
        <div className="bg-gray-900/80 border border-gray-700 rounded-lg p-6 sm:p-8 backdrop-blur-sm text-center">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gray-900/80 border border-gray-700 rounded-lg p-6 sm:p-8 backdrop-blur-sm text-center">
          ...
          <button
            ...
            className="w-full sm:w-auto bg-emerald-500 hover:bg-emerald-600 px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-bold transition-all duration-200"
          >
            🔄 Retry
          </button>
        </div>
    ...
    return (
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gray-900/80 border border-gray-700 rounded-lg p-6 sm:p-8 backdrop-blur-sm text-center">
          ...
          <h3 className="text-xl sm:text-2xl font-bold text-gray-300 mb-2">No Scores Yet!</h3>
          <p className="text-gray-400 mb-4 sm:mb-6">Be the first to play and claim the top spot</p>
          <button
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div
                      className={`font-bold text-sm ${entry._id === walletAddress ? "text-emerald-400" : "text-white"}`}
                    >
                      #{index + 1} {formatWalletAddress(entry._id)}
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs text-gray-400">{new Date(entry.createdAt).toLocaleDateString()}</div>
                </div>
              </div>
            </div>
          ))}
              ...
              >
                <div className="grid grid-cols-12 gap-4 items-center">
                  ...
                  <div className="col-span-1">
                    <div
                      className={`text-xl lg:text-2xl font-black pixel-font ${
                        index === 0
                          ? "text-yellow-400"
                          : index === 1
                            ? "text-gray-300"
                      ...
                      <div>
                        <div
                          className={`font-bold text-sm lg:text-base ${
                            entry._id === walletAddress ? "text-emerald-400" : "text-white"
                          }`}
                        >
